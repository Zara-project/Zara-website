        ...
        <form action="#" autoComplete="off">
            <div className="flex flex-col mb-2">
                <div className="flex relative ">
                    ...
                    <input onChange={e=> {
                        console.log(email)
                        setInEmail(e.target.value)}}  type="text" id="sign-in-email" className=" rounded-r-lg flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-black  focus:border-transparent" placeholder="Your email"/>
                    </div>
                </div>
                <div className="flex flex-col mb-6">
                    <div className="flex relative ">
                        ...
                        setInPassword(e.target.value)}} type="password" id="sign-in-Password" className=" rounded-r-lg flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-black  focus:border-transparent" placeholder="Your password"/>
                        </div>
                    </div>
